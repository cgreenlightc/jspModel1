...
<%
	MemberDto login = (MemberDto)session.getAttribute("login");   // 로그인한 정보들
	if(login == null){
		%>
		<script>
		alert('로그인 해 주십시오');
...
<tr>
	<th>아이디</th>
	<td>
		<input type="text" name="id" size="50px" value="<%=login.getId() %>" readonly="readonly"> <!-- readonly로 아이디 못고치게 막아버림 -->
	</td>
</tr>
<tr>
	<th>제목</th>
